...
exports.EventGetRemoved400ResponseToJSON = exports.EventGetRemoved400ResponseFromJSONTyped = exports.EventGetRemoved400ResponseFromJSON = exports.instanceOfEventGetRemoved400Response = void 0;
/**
 * Check if a given object implements the EventGetRemoved400Response interface.
 */
function instanceOfEventGetRemoved400Response(value) {
    return true;
}
exports.instanceOfEventGetRemoved400Response = instanceOfEventGetRemoved400Response;
function EventGetRemoved400ResponseFromJSON(json) {
    return EventGetRemoved400ResponseFromJSONTyped(json, false);
}
exports.EventGetRemoved400ResponseFromJSON = EventGetRemoved400ResponseFromJSON;
function EventGetRemoved400ResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
exports.EventGetRemoved400ResponseFromJSONTyped = EventGetRemoved400ResponseFromJSONTyped;
function EventGetRemoved400ResponseToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
...
exports.EventGetRemoved400ResponseToJSON = EventGetRemoved400ResponseToJSON;
