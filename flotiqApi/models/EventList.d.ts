 ...
 */
export declare function instanceOfEventList(value: object): boolean;
export declare function EventListFromJSON(json: any): EventList;
export declare function EventListFromJSONTyped(json: any, ignoreDiscriminator: boolean): EventList;
export declare function EventListToJSON(value?: EventList | null): any;
