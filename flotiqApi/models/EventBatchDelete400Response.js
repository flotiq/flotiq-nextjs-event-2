...
exports.EventBatchDelete400ResponseToJSON = exports.EventBatchDelete400ResponseFromJSONTyped = exports.EventBatchDelete400ResponseFromJSON = exports.instanceOfEventBatchDelete400Response = void 0;
/**
 * Check if a given object implements the EventBatchDelete400Response interface.
 */
function instanceOfEventBatchDelete400Response(value) {
    return true;
}
exports.instanceOfEventBatchDelete400Response = instanceOfEventBatchDelete400Response;
function EventBatchDelete400ResponseFromJSON(json) {
    return EventBatchDelete400ResponseFromJSONTyped(json, false);
}
exports.EventBatchDelete400ResponseFromJSON = EventBatchDelete400ResponseFromJSON;
function EventBatchDelete400ResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
exports.EventBatchDelete400ResponseFromJSONTyped = EventBatchDelete400ResponseFromJSONTyped;
function EventBatchDelete400ResponseToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
...
exports.EventBatchDelete400ResponseToJSON = EventBatchDelete400ResponseToJSON;
