...
exports.EventWithoutInternalToJSON = exports.EventWithoutInternalFromJSONTyped = exports.EventWithoutInternalFromJSON = exports.instanceOfEventWithoutInternal = void 0;
var DataSource_1 = require("./DataSource");
/**
 * Check if a given object implements the EventWithoutInternal interface.
 */
function instanceOfEventWithoutInternal(value) {
    if (!('id' in value))
        return false;
    if (!('date' in value))
        return false;
...
exports.instanceOfEventWithoutInternal = instanceOfEventWithoutInternal;
function EventWithoutInternalFromJSON(json) {
    return EventWithoutInternalFromJSONTyped(json, false);
}
exports.EventWithoutInternalFromJSON = EventWithoutInternalFromJSON;
function EventWithoutInternalFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
exports.EventWithoutInternalFromJSONTyped = EventWithoutInternalFromJSONTyped;
function EventWithoutInternalToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
...
exports.EventWithoutInternalToJSON = EventWithoutInternalToJSON;
