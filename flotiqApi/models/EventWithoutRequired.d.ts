 ...
 */
export declare function instanceOfEventWithoutRequired(value: object): boolean;
export declare function EventWithoutRequiredFromJSON(json: any): EventWithoutRequired;
export declare function EventWithoutRequiredFromJSONTyped(json: any, ignoreDiscriminator: boolean): EventWithoutRequired;
export declare function EventWithoutRequiredToJSON(value?: EventWithoutRequired | null): any;
