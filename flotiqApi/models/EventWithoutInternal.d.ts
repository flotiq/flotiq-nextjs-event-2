 ...
 */
export declare function instanceOfEventWithoutInternal(value: object): boolean;
export declare function EventWithoutInternalFromJSON(json: any): EventWithoutInternal;
export declare function EventWithoutInternalFromJSONTyped(json: any, ignoreDiscriminator: boolean): EventWithoutInternal;
export declare function EventWithoutInternalToJSON(value?: EventWithoutInternal | null): any;
