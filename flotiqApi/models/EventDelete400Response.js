...
exports.EventDelete400ResponseToJSON = exports.EventDelete400ResponseFromJSONTyped = exports.EventDelete400ResponseFromJSON = exports.instanceOfEventDelete400Response = void 0;
/**
 * Check if a given object implements the EventDelete400Response interface.
 */
function instanceOfEventDelete400Response(value) {
    return true;
}
exports.instanceOfEventDelete400Response = instanceOfEventDelete400Response;
function EventDelete400ResponseFromJSON(json) {
    return EventDelete400ResponseFromJSONTyped(json, false);
}
exports.EventDelete400ResponseFromJSON = EventDelete400ResponseFromJSON;
function EventDelete400ResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
exports.EventDelete400ResponseFromJSONTyped = EventDelete400ResponseFromJSONTyped;
function EventDelete400ResponseToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
...
exports.EventDelete400ResponseToJSON = EventDelete400ResponseToJSON;
