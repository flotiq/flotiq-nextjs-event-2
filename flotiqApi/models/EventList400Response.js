...
exports.EventList400ResponseToJSON = exports.EventList400ResponseFromJSONTyped = exports.EventList400ResponseFromJSON = exports.instanceOfEventList400Response = void 0;
/**
 * Check if a given object implements the EventList400Response interface.
 */
function instanceOfEventList400Response(value) {
    return true;
}
exports.instanceOfEventList400Response = instanceOfEventList400Response;
function EventList400ResponseFromJSON(json) {
    return EventList400ResponseFromJSONTyped(json, false);
}
exports.EventList400ResponseFromJSON = EventList400ResponseFromJSON;
function EventList400ResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
exports.EventList400ResponseFromJSONTyped = EventList400ResponseFromJSONTyped;
function EventList400ResponseToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
...
exports.EventList400ResponseToJSON = EventList400ResponseToJSON;
