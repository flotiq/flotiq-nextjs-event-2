...
exports.EventVersionsListToJSON = exports.EventVersionsListFromJSONTyped = exports.EventVersionsListFromJSON = exports.instanceOfEventVersionsList = void 0;
var VersionItem_1 = require("./VersionItem");
/**
 * Check if a given object implements the EventVersionsList interface.
 */
function instanceOfEventVersionsList(value) {
...
exports.instanceOfEventVersionsList = instanceOfEventVersionsList;
function EventVersionsListFromJSON(json) {
    return EventVersionsListFromJSONTyped(json, false);
}
exports.EventVersionsListFromJSON = EventVersionsListFromJSON;
function EventVersionsListFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
exports.EventVersionsListFromJSONTyped = EventVersionsListFromJSONTyped;
function EventVersionsListToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
...
exports.EventVersionsListToJSON = EventVersionsListToJSON;
