...
exports.EventListToJSON = exports.EventListFromJSONTyped = exports.EventListFromJSON = exports.instanceOfEventList = void 0;
var Event_1 = require("./Event");
/**
 * Check if a given object implements the EventList interface.
 */
function instanceOfEventList(value) {
...
exports.instanceOfEventList = instanceOfEventList;
function EventListFromJSON(json) {
    return EventListFromJSONTyped(json, false);
}
exports.EventListFromJSON = EventListFromJSON;
function EventListFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
        ...
        'data': json['data'] == null ? undefined : (json['data'].map(Event_1.EventFromJSON)),
    };
}
exports.EventListFromJSONTyped = EventListFromJSONTyped;
function EventListToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
        ...
        'data': value['data'] == null ? undefined : (value['data'].map(Event_1.EventToJSON)),
    };
}
exports.EventListToJSON = EventListToJSON;
