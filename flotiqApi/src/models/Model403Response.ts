 ...
 */
export function instanceOfModel403Response(value: object): boolean {
    return true;
}

export function Model403ResponseFromJSON(json: any): Model403Response {
    return Model403ResponseFromJSONTyped(json, false);
}

export function Model403ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): Model403Response  {
    if (json == null) {
        return json;
    }
        return {
...
export function Model403ResponseToJSON(value?: Model403Response | null): any {
    if (value == null) {
        return value;
    }
    return {
