 ...
 * 
 * @export
 * @interface EventList400Response
 */


export interface EventList400Response {
    /**
     * 
     * @type {Array<string>}
     * @memberof EventList400Response
     */
 ...
 */
export function instanceOfEventList400Response(value: object): boolean {
    return true;
}

export function EventList400ResponseFromJSON(json: any): EventList400Response {
    return EventList400ResponseFromJSONTyped(json, false);
}

export function EventList400ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): EventList400Response  {
    if (json == null) {
        return json;
    }
        return {
...
export function EventList400ResponseToJSON(value?: EventList400Response | null): any {
    if (value == null) {
        return value;
    }
    return {
