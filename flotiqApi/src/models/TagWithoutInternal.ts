 ...
 */
export function instanceOfTagWithoutInternal(value: object): boolean {
    if (!('id' in value)) return false;
    if (!('name' in value)) return false;
    return true;
}

export function TagWithoutInternalFromJSON(json: any): TagWithoutInternal {
    return TagWithoutInternalFromJSONTyped(json, false);
}

export function TagWithoutInternalFromJSONTyped(json: any, ignoreDiscriminator: boolean): TagWithoutInternal  {
    if (json == null) {
        return json;
    }
        return {
...
export function TagWithoutInternalToJSON(value?: TagWithoutInternal | null): any {
    if (value == null) {
        return value;
    }
    return {
