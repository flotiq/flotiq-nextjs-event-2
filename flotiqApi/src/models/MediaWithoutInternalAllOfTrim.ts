 ...
 */
export function instanceOfMediaWithoutInternalAllOfTrim(value: object): boolean {
    if (!('top' in value)) return false;
    if (!('left' in value)) return false;
    return true;
}

export function MediaWithoutInternalAllOfTrimFromJSON(json: any): MediaWithoutInternalAllOfTrim {
    return MediaWithoutInternalAllOfTrimFromJSONTyped(json, false);
}

export function MediaWithoutInternalAllOfTrimFromJSONTyped(json: any, ignoreDiscriminator: boolean): MediaWithoutInternalAllOfTrim  {
    if (json == null) {
        return json;
    }
        return {
...
export function MediaWithoutInternalAllOfTrimToJSON(value?: MediaWithoutInternalAllOfTrim | null): any {
    if (value == null) {
        return value;
    }
    return {
