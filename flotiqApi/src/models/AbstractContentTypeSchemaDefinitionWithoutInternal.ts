 ...
 */
export function instanceOfAbstractContentTypeSchemaDefinitionWithoutInternal(value: object): boolean {
    if (!('id' in value)) return false;
    return true;
}

export function AbstractContentTypeSchemaDefinitionWithoutInternalFromJSON(json: any): AbstractContentTypeSchemaDefinitionWithoutInternal {
    return AbstractContentTypeSchemaDefinitionWithoutInternalFromJSONTyped(json, false);
}

export function AbstractContentTypeSchemaDefinitionWithoutInternalFromJSONTyped(json: any, ignoreDiscriminator: boolean): AbstractContentTypeSchemaDefinitionWithoutInternal  {
    if (json == null) {
        return json;
    }
        return {
...
export function AbstractContentTypeSchemaDefinitionWithoutInternalToJSON(value?: AbstractContentTypeSchemaDefinitionWithoutInternal | null): any {
    if (value == null) {
        return value;
    }
    return {
