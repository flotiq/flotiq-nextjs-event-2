 ...
 * 
 * @export
 * @interface EventCreate400Response
 */


export interface EventCreate400Response {
    /**
     * 
     * @type {Array<string>}
     * @memberof EventCreate400Response
     */
 ...
 */
export function instanceOfEventCreate400Response(value: object): boolean {
    return true;
}

export function EventCreate400ResponseFromJSON(json: any): EventCreate400Response {
    return EventCreate400ResponseFromJSONTyped(json, false);
}

export function EventCreate400ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): EventCreate400Response  {
    if (json == null) {
        return json;
    }
        return {
...
export function EventCreate400ResponseToJSON(value?: EventCreate400Response | null): any {
    if (value == null) {
        return value;
    }
    return {
