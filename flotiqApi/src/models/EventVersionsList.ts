 ...
 * 
 * @export
 * @interface EventVersionsList
 */


export interface EventVersionsList {
    /**
     * 
     * @type {number}
     * @memberof EventVersionsList
     */
 ...
 */
export function instanceOfEventVersionsList(value: object): boolean {
...
export function EventVersionsListFromJSON(json: any): EventVersionsList {
    return EventVersionsListFromJSONTyped(json, false);
}

export function EventVersionsListFromJSONTyped(json: any, ignoreDiscriminator: boolean): EventVersionsList  {
    if (json == null) {
        return json;
    }
        return {
...
export function EventVersionsListToJSON(value?: EventVersionsList | null): any {
    if (value == null) {
        return value;
    }
    return {
