 ...
 */
export function instanceOfAbstractContentTypeSchemaDefinitionInternal(value: object): boolean {
...
export function AbstractContentTypeSchemaDefinitionInternalFromJSON(json: any): AbstractContentTypeSchemaDefinitionInternal {
    return AbstractContentTypeSchemaDefinitionInternalFromJSONTyped(json, false);
}

export function AbstractContentTypeSchemaDefinitionInternalFromJSONTyped(json: any, ignoreDiscriminator: boolean): AbstractContentTypeSchemaDefinitionInternal  {
    if (json == null) {
        return json;
    }
        return {
...
export function AbstractContentTypeSchemaDefinitionInternalToJSON(value?: AbstractContentTypeSchemaDefinitionInternal | null): any {
    if (value == null) {
        return value;
    }
    return {
