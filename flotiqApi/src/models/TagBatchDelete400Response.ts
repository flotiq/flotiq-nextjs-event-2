 ...
 */
export function instanceOfTagBatchDelete400Response(value: object): boolean {
    return true;
}

export function TagBatchDelete400ResponseFromJSON(json: any): TagBatchDelete400Response {
    return TagBatchDelete400ResponseFromJSONTyped(json, false);
}

export function TagBatchDelete400ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TagBatchDelete400Response  {
    if (json == null) {
        return json;
    }
        return {
...
export function TagBatchDelete400ResponseToJSON(value?: TagBatchDelete400Response | null): any {
    if (value == null) {
        return value;
    }
    return {
