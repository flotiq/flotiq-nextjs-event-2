 ...
 * 
 * @export
 * @interface EventDelete400Response
 */


export interface EventDelete400Response {
    /**
     * 
     * @type {Array<string>}
     * @memberof EventDelete400Response
     */
 ...
 */
export function instanceOfEventDelete400Response(value: object): boolean {
    return true;
}

export function EventDelete400ResponseFromJSON(json: any): EventDelete400Response {
    return EventDelete400ResponseFromJSONTyped(json, false);
}

export function EventDelete400ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): EventDelete400Response  {
    if (json == null) {
        return json;
    }
        return {
...
export function EventDelete400ResponseToJSON(value?: EventDelete400Response | null): any {
    if (value == null) {
        return value;
    }
    return {
