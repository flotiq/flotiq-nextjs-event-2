 ...
 * 
 * @export
 * @interface EventGetRemoved400Response
 */


export interface EventGetRemoved400Response {
    /**
     * 
     * @type {Array<string>}
     * @memberof EventGetRemoved400Response
     */
 ...
 */
export function instanceOfEventGetRemoved400Response(value: object): boolean {
    return true;
}

export function EventGetRemoved400ResponseFromJSON(json: any): EventGetRemoved400Response {
    return EventGetRemoved400ResponseFromJSONTyped(json, false);
}

export function EventGetRemoved400ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): EventGetRemoved400Response  {
    if (json == null) {
        return json;
    }
        return {
...
export function EventGetRemoved400ResponseToJSON(value?: EventGetRemoved400Response | null): any {
    if (value == null) {
        return value;
    }
    return {
