 ...
 * 
 * @export
 * @interface EventWithoutInternal
 */
 ...
 */
export function instanceOfEventWithoutInternal(value: object): boolean {
...
export function EventWithoutInternalFromJSON(json: any): EventWithoutInternal {
    return EventWithoutInternalFromJSONTyped(json, false);
}

export function EventWithoutInternalFromJSONTyped(json: any, ignoreDiscriminator: boolean): EventWithoutInternal  {
    if (json == null) {
        return json;
    }
        return {
...
export function EventWithoutInternalToJSON(value?: EventWithoutInternal | null): any {
    if (value == null) {
        return value;
    }
    return {
