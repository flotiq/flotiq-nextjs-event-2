 ...
 * 
 * @export
 * @interface EventWithoutRequired
 */


export interface EventWithoutRequired {
    /**
     * Unique ID of the object
     * @type {string}
     * @memberof EventWithoutRequired
     */
 ...
 */
export function instanceOfEventWithoutRequired(value: object): boolean {
    if (!('id' in value)) return false;
    return true;
}

export function EventWithoutRequiredFromJSON(json: any): EventWithoutRequired {
    return EventWithoutRequiredFromJSONTyped(json, false);
}

export function EventWithoutRequiredFromJSONTyped(json: any, ignoreDiscriminator: boolean): EventWithoutRequired  {
    if (json == null) {
        return json;
    }
        return {
        ...
        'image': json['image'] == null ? undefined : ((json['image'] as Array<any>).map(DataSourceFromJSON)),
...
export function EventWithoutRequiredToJSON(value?: EventWithoutRequired | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'name': value['name'],
        'slug': value['slug'],
        'image': value['image'] == null ? undefined : ((value['image'] as Array<any>).map(DataSourceToJSON)),
        'price': value['price'],
