 ...
 */
export function instanceOfVersionItemAllOfOwner(value: object): boolean {
    return true;
}

export function VersionItemAllOfOwnerFromJSON(json: any): VersionItemAllOfOwner {
    return VersionItemAllOfOwnerFromJSONTyped(json, false);
}

export function VersionItemAllOfOwnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): VersionItemAllOfOwner  {
    if (json == null) {
        return json;
    }
        return {
...
export function VersionItemAllOfOwnerToJSON(value?: VersionItemAllOfOwner | null): any {
    if (value == null) {
        return value;
    }
    return {
