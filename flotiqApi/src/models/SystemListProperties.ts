 ...
 */
export function instanceOfSystemListProperties(value: object): boolean {
...
export function SystemListPropertiesFromJSON(json: any): SystemListProperties {
    return SystemListPropertiesFromJSONTyped(json, false);
}

export function SystemListPropertiesFromJSONTyped(json: any, ignoreDiscriminator: boolean): SystemListProperties  {
    if (json == null) {
        return json;
    }
        return {
...
export function SystemListPropertiesToJSON(value?: SystemListProperties | null): any {
    if (value == null) {
        return value;
    }
    return {
