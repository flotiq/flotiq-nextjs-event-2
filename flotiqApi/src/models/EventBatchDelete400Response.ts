 ...
 * 
 * @export
 * @interface EventBatchDelete400Response
 */


export interface EventBatchDelete400Response {
    /**
     * 
     * @type {Array<string>}
     * @memberof EventBatchDelete400Response
     */
 ...
 */
export function instanceOfEventBatchDelete400Response(value: object): boolean {
    return true;
}

export function EventBatchDelete400ResponseFromJSON(json: any): EventBatchDelete400Response {
    return EventBatchDelete400ResponseFromJSONTyped(json, false);
}

export function EventBatchDelete400ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): EventBatchDelete400Response  {
    if (json == null) {
        return json;
    }
        return {
...
export function EventBatchDelete400ResponseToJSON(value?: EventBatchDelete400Response | null): any {
    if (value == null) {
        return value;
    }
    return {
