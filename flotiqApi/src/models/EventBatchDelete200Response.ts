 ...
 * 
 * @export
 * @interface EventBatchDelete200Response
 */


export interface EventBatchDelete200Response {
    /**
     * 
     * @type {number}
     * @memberof EventBatchDelete200Response
     */
 ...
 */
export function instanceOfEventBatchDelete200Response(value: object): boolean {
    return true;
}

export function EventBatchDelete200ResponseFromJSON(json: any): EventBatchDelete200Response {
    return EventBatchDelete200ResponseFromJSONTyped(json, false);
}

export function EventBatchDelete200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): EventBatchDelete200Response  {
    if (json == null) {
        return json;
    }
        return {
...
export function EventBatchDelete200ResponseToJSON(value?: EventBatchDelete200Response | null): any {
    if (value == null) {
        return value;
    }
    return {
