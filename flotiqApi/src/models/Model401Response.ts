 ...
 */
export function instanceOfModel401Response(value: object): boolean {
    return true;
}

export function Model401ResponseFromJSON(json: any): Model401Response {
    return Model401ResponseFromJSONTyped(json, false);
}

export function Model401ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): Model401Response  {
    if (json == null) {
        return json;
    }
        return {
...
export function Model401ResponseToJSON(value?: Model401Response | null): any {
    if (value == null) {
        return value;
    }
    return {
