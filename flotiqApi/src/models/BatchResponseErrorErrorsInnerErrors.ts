 ...
 */
export function instanceOfBatchResponseErrorErrorsInnerErrors(value: object): boolean {
    return true;
}

export function BatchResponseErrorErrorsInnerErrorsFromJSON(json: any): BatchResponseErrorErrorsInnerErrors {
    return BatchResponseErrorErrorsInnerErrorsFromJSONTyped(json, false);
}

export function BatchResponseErrorErrorsInnerErrorsFromJSONTyped(json: any, ignoreDiscriminator: boolean): BatchResponseErrorErrorsInnerErrors  {
    if (json == null) {
        return json;
    }
        return {
...
export function BatchResponseErrorErrorsInnerErrorsToJSON(value?: BatchResponseErrorErrorsInnerErrors | null): any {
    if (value == null) {
        return value;
    }
    return {
