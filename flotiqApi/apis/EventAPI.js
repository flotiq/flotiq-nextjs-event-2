...
var EventAPI = /** @class */ (function (_super) {
     ...
     */
    EventAPI.prototype._deleteRaw = function (requestParameters, initOverrides) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2: return [4 /*yield*/, this.request({
                            path: "/api/v1/content/event/{id}".replace("{".concat("id", "}"), encodeURIComponent(String(requestParameters['id']))),
                            method: 'DELETE',
     ...
     * Delete a Event object
     */
    EventAPI.prototype._delete = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    EventAPI.prototype.batchCreateRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, _a, _b, response;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2: return [4 /*yield*/, this.request({
                            ...
                            headers: headerParameters,
                            query: queryParameters,
                            body: requestParameters['EventWithoutInternal'].map(index_1.EventWithoutInternalToJSON),
                        }, initOverrides)];
                    case 3:
                        response = _c.sent();
     ...
     */
    EventAPI.prototype.batchDeleteRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, _a, _b, response;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        response = _c.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, index_1.EventBatchDelete200ResponseFromJSON)(jsonValue); })];
                }
            });
        });
    };
     ...
     */
    EventAPI.prototype.batchPatchRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, _a, _b, response;
            return __generator(this, function (_c) {
                switch (_c.label) {
     ...
     */
    EventAPI.prototype.createRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, _a, _b, response;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2: return [4 /*yield*/, this.request({
                            ...
                            headers: headerParameters,
                            query: queryParameters,
                            body: (0, index_1.EventWithoutInternalToJSON)(requestParameters['EventWithoutInternal']),
                        }, initOverrides)];
                    case 3:
                        response = _c.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, index_1.EventFromJSON)(jsonValue); })];
                }
            });
        });
    };
     ...
     */
    EventAPI.prototype.getRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, _a, _b, response;
            return __generator(this, function (_c) {
                switch (_c.label) {
     ...
     * Get Event object by Id
     */
    EventAPI.prototype.get = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     */
    EventAPI.prototype.getRemovedRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, _a, _b, response;
            return __generator(this, function (_c) {
                switch (_c.label) {
     ...
     */
    EventAPI.prototype.getVersionsRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, _a, _b, response;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        _c.label = 2;
                    case 2: return [4 /*yield*/, this.request({
                            path: "/api/v1/content/event/{id}/version/{versionId}".replace("{".concat("id", "}"), encodeURIComponent(String(requestParameters['id']))).replace("{".concat("versionId", "}"), encodeURIComponent(String(requestParameters['versionId']))),
                            method: 'GET',
                            headers: headerParameters,
                            query: queryParameters,
                        }, initOverrides)];
     ...
     * Get a specific version of Event object
     */
    EventAPI.prototype.getVersions = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     * List Event objects
     */
    EventAPI.prototype.listRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, _a, _b, response;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        response = _c.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, index_1.EventListFromJSON)(jsonValue); })];
                }
            });
        });
    };
     ...
     */
    EventAPI.prototype.listVersionRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, _a, _b, response;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        _c.label = 2;
                    case 2: return [4 /*yield*/, this.request({
                            path: "/api/v1/content/event/{id}/version".replace("{".concat("id", "}"), encodeURIComponent(String(requestParameters['id']))),
                            method: 'GET',
                            headers: headerParameters,
                            query: queryParameters,
                        }, initOverrides)];
                    case 3:
                        response = _c.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, index_1.EventVersionsListFromJSON)(jsonValue); })];
                }
            });
        });
    };
     ...
     * List all versions of a Event object
     */
    EventAPI.prototype.listVersion = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     */
    EventAPI.prototype.patchRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, _a, _b, response;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2: return [4 /*yield*/, this.request({
                            ...
                            headers: headerParameters,
                            query: queryParameters,
                            body: (0, index_1.EventWithoutRequiredToJSON)(requestParameters['EventWithoutRequired']),
                        }, initOverrides)];
                    case 3:
                        response = _c.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, index_1.EventFromJSON)(jsonValue); })];
     ...
     * Update selected fields of Event object
     */
    EventAPI.prototype.patch = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     */
    EventAPI.prototype.updateRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, _a, _b, response;
            return __generator(this, function (_c) {
                switch (_c.label) {
     ...
     * Update existing Event object
     */
    EventAPI.prototype.update = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
